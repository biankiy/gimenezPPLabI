...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            {
                printf("[ERROR]-Primero debe ingresar una moto para poder modificarla\n\n");
            }
            break;
        case 3:
            //BAJA MOTO
            ...
            {
                printf("[ERROR]-Primero debe ingresar una moto para poder darla de baja\n\n");
            }
            break;
        case 4:
            //LISTAR MOTOS
            ...
            {
                printf("[ERROR]-Primero debe ingresar una moto para poder listar\n\n");
            }
            break;
        case 5:
            //LISTAR TIPOS
        ...
        case 8:
            ...
            {
                printf("\n[ERROR]-Primero debe ingresar una moto para poder darla de alta trabajos\n\n");
            }
            break;
        case 9:
            //LISTAR TRABAJOS
            ...
            {
                printf("[ERROR]-Primero debe ingresar trabajos para poder listarlos\n\n");
            }
            break;
        case 10:
